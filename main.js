...
const gameWinScoreSpan = document.querySelector("#gameWinScoreSpan");
...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        // this.player.setSize(80,15).setOrigin(10,70);
    ...
    if(this.points >=10){
        gameWinScoreSpan.textContent = this.points;
        gameEndScoreSpan.textContent = "Win!";
    }else{
        gameWinScoreSpan.textContent = this.points;
        gameEndScoreSpan.textContent = "Lose!";
    }
